...
            </p>
            <div className="mt-6">
                <button className="group bg-black hover:bg-zinc-800 text-white px-7 py-2.5 rounded-lg  transition-colors">
    Resume
...
                    <img 
                        ...
                        alt="LeetCode" 
                        className="size-7 grayscale hover:grayscale-0 transition-all" 
                    />
                </a>
                <a href="#" className="inline-flex hover:-translate-y-0.5 transition">
                    <img 
